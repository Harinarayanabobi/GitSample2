...
// ask for user input for book id
			...
			bookId = scan.nextInt();
//use scan.nextLine(); to remove the left over the newline character inthe buffer.
//This clears the buffer, allowing the subsequent nextLine() method tocorrectly read the input value
			scan.nextLine();
// or
// bookId=Integer.parseInt(scan.nextLine()); // remove the cursor afterid input
